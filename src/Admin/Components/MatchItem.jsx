        ...
        >
            ...
            <Grid container alignItems="center" justifyContent="space-between" padding={1} position="relative">
                ...
                <Grid item xs={1} textAlign="center">
                    <Typography variant="h6" fontFamily="Oswald" color="green" > {match.puntosLocal} </Typography>
                </Grid>
                ...
                <Grid item xs={1} textAlign="center">
                    <Typography variant="h6" color="red" fontFamily="Oswald" > {match.puntosRival} </Typography>
                </Grid>
                <Grid item xs={2} textAlign="center">
                    <img src={match.logoRival} alt="" width="100%" style={{ maxWidth: "45px" }} />
                </Grid>
            </Grid>
        </Grid >
    )
