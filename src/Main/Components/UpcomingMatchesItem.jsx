...
export const UpcomingMatchesItem = ({ match }) => {
    ...
    return (
        ...
        >
            <Grid container alignItems="start" padding={2}>
                <Grid item xs={8}>
